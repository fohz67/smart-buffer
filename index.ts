...
function main(): void {
    ...
    console.log("Read String:", buffer.readString(5, null));
    console.log("Read Int8:", buffer.readInt8(null));
    console.log("Read String:", buffer.readString(11, null));
    ...
    console.log("Read String NT:", buffer.readStringNT(3, null));
}
